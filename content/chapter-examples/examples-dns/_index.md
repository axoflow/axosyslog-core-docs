...
- If possible, resolve the hostnames locally using the `use-dns(persist_only)` option. For details, see {{% xref "/chapter-examples/examples-dns/example-local-dns/_index.md" %}}.
