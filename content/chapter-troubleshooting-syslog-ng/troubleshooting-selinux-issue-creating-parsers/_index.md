...
To resolve this issue, switch off the PCRE JIT compile function by using the [disable-jit]({{< relref "/chapter-manipulating-messages/regular-expressions/reference-regexp-types/_index.md#PCRE-flags" >}}) `flags()` option in the given filter or rewrite rule of your configuration.
