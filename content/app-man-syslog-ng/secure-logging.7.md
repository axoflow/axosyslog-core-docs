...
In a real deployment, the above steps would typically be automated using a scripting engine. See <link linkend="slogverify.1">`slogverify`(1)</link> for details on verification in iterative mode.</para>
