...
description: "Monitor AxoSyslog with metrics and statistics: query them with syslog-ng-ctl, read them from the internal() source, or scrape them with Prometheus."
weight:  3700
---
